...
@Component
@Slf4j
public class AderRequestResponseLoggingFilter extends OncePerRequestFilter {
    ...
    private void logRequest(HttpServletRequest request) {
        String suffix = "";
        String logMessage = createLogMessage(request, suffix);
        log.info(logMessage);
    }

    private void logResponse(HttpServletResponse response) {
        String suffix = "";
        String logMessage = createLogMessage(response, suffix);
        log.info(logMessage);
    }

    private String createLogMessage(HttpServletRequest request, String suffix) {
        StringBuilder msg = new StringBuilder();
        msg.append(AderRequestResponseLoggingFilter.DEFAULT_REQUEST_MESSAGE_PREFIX);
    ...
    private String createLogMessage(HttpServletResponse response, String suffix) {
        StringBuilder msg = new StringBuilder();
        msg.append(AderRequestResponseLoggingFilter.DEFAULT_RESPONSE_MESSAGE_PREFIX);
